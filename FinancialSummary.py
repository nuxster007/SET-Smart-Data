...
FINANCIAL_SUMMARY_URL = "https://www.set.or.th/th/market/product/stock/quote/@COMPANY_SYMBOL@/financial-statement/company-highlights"
...
exclude_items = ["บัญชีทางการเงินที่สำคัญ", "อัตราส่วนทางการเงินที่สำคัญ"]

dfs[0] = dfs[0][~ dfs[0]["งวดงบการเงิน ณ วันที่"].isin(exclude_items)]
